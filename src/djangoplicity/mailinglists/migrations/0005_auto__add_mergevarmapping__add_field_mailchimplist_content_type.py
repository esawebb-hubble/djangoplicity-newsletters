...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MergeVarMapping'
        db.create_table('mailinglists_mergevarmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailinglists.MailChimpList'])),
            ('merge_var', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailinglists.MailChimpMergeVar'])),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mailinglists', ['MergeVarMapping'])

        # Adding field 'MailChimpList.content_type'
        db.add_column('mailinglists_mailchimplist', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'MergeVarMapping'
        db.delete_table('mailinglists_mergevarmapping')

        # Deleting field 'MailChimpList.content_type'
        db.delete_column('mailinglists_mailchimplist', 'content_type_id')
