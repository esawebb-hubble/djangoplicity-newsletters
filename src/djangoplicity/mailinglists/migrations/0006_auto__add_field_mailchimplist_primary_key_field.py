...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailChimpList.primary_key_field'
        db.add_column('mailinglists_mailchimplist', 'primary_key_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailinglists.MailChimpMergeVar'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MailChimpList.primary_key_field'
        db.delete_column('mailinglists_mailchimplist', 'primary_key_field_id')
