...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MailChimpGrouping'
        db.create_table('mailinglists_mailchimpgrouping', (
        ...
        db.send_create_signal('mailinglists', ['MailChimpGrouping'])


    def backwards(self, orm):
        
        # Deleting model 'MailChimpGrouping'
        db.delete_table('mailinglists_mailchimpgrouping')
