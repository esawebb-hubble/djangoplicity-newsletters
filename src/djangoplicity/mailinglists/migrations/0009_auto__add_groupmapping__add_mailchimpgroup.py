...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mailinglists_groupmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailinglists.MailChimpList'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailinglists.MailChimpGroup'])),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mailinglists', ['GroupMapping'])

        # Adding model 'MailChimpGroup'
        db.create_table('mailinglists_mailchimpgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailinglists.MailChimpList'])),
            ('group_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mailinglists', ['MailChimpGroup'])


    def backwards(self, orm):
        # Deleting model 'GroupMapping'
        db.delete_table('mailinglists_groupmapping')

        # Deleting model 'MailChimpGroup'
        db.delete_table('mailinglists_mailchimpgroup')
    ...
    models = {
        ...
        'mailinglists.groupmapping': {
            'Meta': {'object_name': 'GroupMapping'},
            'field': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mailinglists.MailChimpGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'mailinglists.list': {
            ...
            'password': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
        ...
        'mailinglists.mailchimpgroup': {
            'Meta': {'object_name': 'MailChimpGroup'},
            'group_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mailinglists.MailChimpList']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'mailinglists.mailchimpgrouping': {
            'Meta': {'ordering': "['name', 'option']", 'object_name': 'MailChimpGrouping'},
            'group_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mailinglists.MailChimpList']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'mailinglists.mailchimpmergevar': {
            'Meta': {'ordering': "['list', 'name']", 'object_name': 'MailChimpMergeVar'},
