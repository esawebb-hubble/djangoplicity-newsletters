...
class Migration(SchemaMigration):
	depends_on = (
		( "newsletters", "0004_auto__del_list__del_bademailaddress__del_mailchimplisttoken__del_mailc" ),
	)

	def forwards(self, orm):
		
		# Adding field 'List.base_url'
		db.add_column('mailinglists_list', 'base_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


	def backwards(self, orm):
		
		# Deleting field 'List.base_url'
		db.delete_column('mailinglists_list', 'base_url')
