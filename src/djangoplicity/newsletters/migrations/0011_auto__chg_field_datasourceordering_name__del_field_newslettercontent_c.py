...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Changing field 'DataSourceOrdering.name'
		db.alter_column('newsletters_datasourceordering', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

		# Removing index on 'DataSourceOrdering', fields ['name']
		#db.delete_index('newsletters_datasourceordering', ['name'])

		# Deleting field 'NewsletterContent.content_type'
		db.delete_column('newsletters_newslettercontent', 'content_type_id')

		# Deleting field 'NewsletterContent.subgroup'
		db.delete_column('newsletters_newslettercontent', 'subgroup')


	def backwards(self, orm):
		pass
		# Adding index on 'DataSourceOrdering', fields ['name']
		#db.create_index('newsletters_datasourceordering', ['name'])

		# Changing field 'DataSourceOrdering.name'
		#db.alter_column('newsletters_datasourceordering', 'name', self.gf('django.db.models.fields.SlugField')(max_length=255))

		# User chose to not deal with backwards NULL issues for 'NewsletterContent.content_type'
		raise RuntimeError("Cannot reverse this migration. 'NewsletterContent.content_type' and its values cannot be restored.")

		# Adding field 'NewsletterContent.subgroup'
		#db.add_column('newsletters_newslettercontent', 'subgroup', self.gf('django.db.models.fields.SlugField')(blank=True, default='', max_length=50, db_index=True), keep_default=False)
