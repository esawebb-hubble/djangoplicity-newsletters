...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('newsletters_newslettercontent', 'object_id', self.gf('django.db.models.fields.SlugField')(max_length=50, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'NewsletterContent.object_id'
        db.alter_column('newsletters_newslettercontent', 'object_id', self.gf('djangoplicity.archives.fields.IdField')(max_length=50, primary_key=True))
    ...
    models = {
        ...
        'newsletters.newslettercontent': {
            ...
            'object_id': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'primary_key': 'True', 'db_index': 'True'}),
