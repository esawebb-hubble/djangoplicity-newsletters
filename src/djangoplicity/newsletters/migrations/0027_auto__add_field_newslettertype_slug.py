...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterType.slug'
        db.add_column('newsletters_newslettertype', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterType.slug'
        db.delete_column('newsletters_newslettertype', 'slug')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'260'", 'max_length': '50', 'primary_key': 'True'}),
