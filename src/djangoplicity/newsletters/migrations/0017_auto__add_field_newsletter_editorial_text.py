...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Newsletter.editorial_text'
        db.add_column('newsletters_newsletter', 'editorial_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Newsletter.editorial_text'
        db.delete_column('newsletters_newsletter', 'editorial_text')
