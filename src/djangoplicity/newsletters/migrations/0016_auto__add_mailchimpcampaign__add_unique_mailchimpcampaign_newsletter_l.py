...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MailChimpCampaign'
        db.create_table('newsletters_mailchimpcampaign', (
        ...
        db.send_create_signal('newsletters', ['MailChimpCampaign'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MailChimpCampaign'
        db.delete_table('newsletters_mailchimpcampaign')
