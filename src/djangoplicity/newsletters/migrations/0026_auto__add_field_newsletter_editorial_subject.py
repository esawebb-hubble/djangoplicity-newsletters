...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.editorial_subject'
        db.add_column('newsletters_newsletter', 'editorial_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.editorial_subject'
        db.delete_column('newsletters_newsletter', 'editorial_subject')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'257'", 'max_length': '50', 'primary_key': 'True'}),
