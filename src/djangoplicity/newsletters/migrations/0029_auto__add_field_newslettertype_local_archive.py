...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterType.local_archive'
        db.add_column('newsletters_newslettertype', 'local_archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterType.local_archive'
        db.delete_column('newsletters_newslettertype', 'local_archive')
