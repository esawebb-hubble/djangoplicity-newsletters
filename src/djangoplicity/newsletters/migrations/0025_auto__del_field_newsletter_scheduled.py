...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Newsletter.scheduled'
        db.delete_column('newsletters_newsletter', 'scheduled')


    def backwards(self, orm):
        # Adding field 'Newsletter.scheduled'
        db.add_column('newsletters_newsletter', 'scheduled',
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'254'", 'max_length': '50', 'primary_key': 'True'}),
