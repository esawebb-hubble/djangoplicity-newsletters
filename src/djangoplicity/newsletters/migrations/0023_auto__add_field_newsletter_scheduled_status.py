...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.scheduled_status'
        db.add_column('newsletters_newsletter', 'scheduled_status',
                      self.gf('django.db.models.fields.CharField')(default='OFF', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.scheduled_status'
        db.delete_column('newsletters_newsletter', 'scheduled_status')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'255'", 'max_length': '50', 'primary_key': 'True'}),
