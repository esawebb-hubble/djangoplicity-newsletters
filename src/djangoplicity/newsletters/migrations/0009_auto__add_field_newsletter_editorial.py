...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Newsletter.editorial'
        db.add_column('newsletters_newsletter', 'editorial', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Newsletter.editorial'
        db.delete_column('newsletters_newsletter', 'editorial')
