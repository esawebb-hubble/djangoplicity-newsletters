...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewsletterLanguage'
        db.create_table('newsletters_newsletterlanguage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('newsletter_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newsletters.NewsletterType'])),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newsletters.Language'])),
            ('default_from_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('default_from_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('default_editorial', self.gf('tinymce.models.HTMLField')(blank=True)),
            ('default_editorial_text', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('newsletters', ['NewsletterLanguage'])

        # Deleting field 'Language.default_editorial'
        db.delete_column('newsletters_language', 'default_editorial')

        # Deleting field 'Language.default_from_name'
        db.delete_column('newsletters_language', 'default_from_name')

        # Deleting field 'Language.default_editorial_text'
        db.delete_column('newsletters_language', 'default_editorial_text')
    ...
    def backwards(self, orm):
        # Deleting model 'NewsletterLanguage'
        db.delete_table('newsletters_newsletterlanguage')

        # Adding field 'Language.default_editorial'
        db.add_column('newsletters_language', 'default_editorial',
        ...
        # Adding field 'Language.default_editorial_text'
        db.add_column('newsletters_language', 'default_editorial_text',
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'298'", 'max_length': '50', 'primary_key': 'True'}),
        ...
        'newsletters.newsletterlanguage': {
            'Meta': {'object_name': 'NewsletterLanguage'},
            'default_editorial': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'default_editorial_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['newsletters.Language']"}),
            'newsletter_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['newsletters.NewsletterType']"})
        },
        'newsletters.newslettertype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'languages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['newsletters.Language']", 'symmetrical': 'False', 'through': "orm['newsletters.NewsletterLanguage']", 'blank': 'True'}),
