...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Newsletter.scheduled_task_id'
        db.add_column('newsletters_newsletter', 'scheduled_task_id', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Newsletter.scheduled_task_id'
        db.delete_column('newsletters_newsletter', 'scheduled_task_id')
