...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataSourceSelector.type'
        db.add_column('newsletters_datasourceselector', 'type', self.gf('django.db.models.fields.CharField')(default='str', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataSourceSelector.type'
        db.delete_column('newsletters_datasourceselector', 'type')
