...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterType.internal_archive'
        db.add_column('newsletters_newslettertype', 'internal_archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterType.internal_archive'
        db.delete_column('newsletters_newslettertype', 'internal_archive')
    ...
    models = {
        ...
        'newsletters.language': {
            'Meta': {'ordering': "['lang']", 'object_name': 'Language'},
        ...
        'newsletters.newsletter': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'306'", 'max_length': '50', 'primary_key': 'True'}),
        ...
        'newsletters.newsletterlanguage': {
            'Meta': {'ordering': "['language']", 'object_name': 'NewsletterLanguage'},
        ...
        'newsletters.newslettertype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_archive': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
