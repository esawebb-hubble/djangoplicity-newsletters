...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailerParameter.help_text'
        db.add_column('newsletters_mailerparameter', 'help_text', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MailerParameter.help_text'
        db.delete_column('newsletters_mailerparameter', 'help_text')
