...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Newsletter.editorial'
        db.alter_column('newsletters_newsletter', 'editorial', self.gf('tinymce.models.HTMLField')())


    def backwards(self, orm):
        
        # Changing field 'Newsletter.editorial'
        db.alter_column('newsletters_newsletter', 'editorial', self.gf('django.db.models.fields.TextField')())
