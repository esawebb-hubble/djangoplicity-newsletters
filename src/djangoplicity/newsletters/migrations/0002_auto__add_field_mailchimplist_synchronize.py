...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailChimpList.synchronize'
        db.add_column('newsletters_mailchimplist', 'synchronize', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MailChimpList.synchronize'
        db.delete_column('newsletters_mailchimplist', 'synchronize')
