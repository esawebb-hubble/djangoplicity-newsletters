...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterType.subscribe_text'
        db.add_column('newsletters_newslettertype', 'subscribe_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterType.subscribe_text'
        db.delete_column('newsletters_newslettertype', 'subscribe_text')
    ...
    models = {
        ...
        'newsletters.newsletter': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'286'", 'max_length': '50', 'primary_key': 'True'}),
