...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('newsletters_localnewsletter', 'newsletter_id', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        db.alter_column('newsletters_localnewsletter', 'newsletter_id', self.gf('django.db.models.fields.related.ForeignKey'))
